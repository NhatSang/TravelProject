...
<body>
	...
	<div class="body_manager">
		<h1 class="title">Quản lý điểm đi</h1>
		<input type="button" value="Thêm điểm đi"
			onclick="window.location.href='addDeparture'; return false;"
		...
		<div class="table" style="alialign-items: center;display: flex;justify-content: center">
			<table  >
				...
				<c:forEach var="tempDeparture" items="${departure}">
