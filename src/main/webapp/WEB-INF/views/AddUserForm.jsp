...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/styleAddUserForm.css" />
<body>
</head>
<body>
	...
	<div class="container" > 
		<h2 class="title">CẬP NHẬT NGƯỜI DÙNG</h2>
			<form:form action="saveUser"  modelAttribute="user"  method="POST" class="form" >
			...
			<div>
				<p>
                    <a href="${pageContext.request.contextPath}/user/showUsers" class="back">Quay lại</a>
            </p>
			</div>
